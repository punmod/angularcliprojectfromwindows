...
var DataTableDemo3 = /** @class */ (function () {
    function DataTableDemo3() {
        var _this = this;
        this.filmResource = new angular_4_data_table_bootstrap_4_1.DataTableResource(data_table_demo3_data_1.films);
        this.films = [];
        this.filmCount = 0;
        // special params:
        this.translations = {
    ...
    ;
    __decorate([
        core_1.ViewChild(angular_4_data_table_bootstrap_4_1.DataTable),
